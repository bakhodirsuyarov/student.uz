...
let fromCost = document.querySelector(".content__from-cost")
let toCost = document.querySelector(".content__to-cost")
...
function makeCard(params){
  ...
  params.map((item, index) =>{
      ...
      let FastFoodcontentLocation = document.createElement("iframe");
      FastFoodcontentLocation.src = item.link
...
function makeItem(params){
  ...
  params.map((item, index)=>{
      ...
      let MilliycontentLocation = document.createElement("iframe");
      MilliycontentLocation.src = item.link
...
function maxCost(){
 let result = maxWay.filter(item =>{
  return item.cost > fromCost.value && item.cost < toCost.value
 })
